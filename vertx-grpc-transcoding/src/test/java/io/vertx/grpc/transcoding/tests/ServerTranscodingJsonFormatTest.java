...
import static io.vertx.grpc.transcoding.tests.ServerTranscodingTest.ECHO_REQUEST_DECODER;
import static io.vertx.grpc.transcoding.tests.ServerTranscodingTest.ECHO_RESPONSE_ENCODER;
import static io.vertx.grpc.transcoding.tests.ServerTranscodingTest.TEST_SERVICE_NAME;
...
public class ServerTranscodingJsonFormatTest extends GrpcTestBase {
  ...
  public void testServerOptionsLenientParserAcceptsUnknownField(TestContext should) {
    GrpcServerOptions lenient = new GrpcServerOptions()

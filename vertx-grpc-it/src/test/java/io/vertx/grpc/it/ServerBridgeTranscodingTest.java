...
public class ServerBridgeTranscodingTest extends GrpcTestBase {
  ...
  public void setUp(TestContext should) {
    ...
    grpcServer.callHandler(UNARY_CALL_WITH_PARAM, req -> bridge.handler(UNARY_CALL_WITH_PARAM).handle(req));
    grpcServer.callHandler(UNARY_CALL_WITH_BODY, req -> bridge.handler(UNARY_CALL_WITH_BODY).handle(req));
    grpcServer.callHandler(UNARY_CALL_WITH_QUERY, req -> bridge.handler(UNARY_CALL_WITH_QUERY).handle(req));
    grpcServer.callHandler(EMPTY_CALL, req -> bridge.handler(EMPTY_CALL).handle(req));

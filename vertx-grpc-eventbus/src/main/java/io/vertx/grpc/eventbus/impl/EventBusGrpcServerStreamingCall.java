...
public class EventBusGrpcServerStreamingCall extends EventBusGrpcStreamBase {
  ...
  public EventBusGrpcServerStreamingCall(ContextInternal context, EventBus eventBus, String clientAddress, String serverAddress, WireFormat wireFormat, String encoding,
    int window) {
    ...
    this.inboundConsumer = eventBus.consumer(serverAddress, this::handleInbound);
  }

  EventBusGrpcServerStreamingCall listenHandler(Handler<Void> handler) {

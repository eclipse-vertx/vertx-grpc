...
public class GrpcEventBusExamples {
  ...
  public void clientWithService(Vertx vertx) {
    ...
    GreeterClient greeter = GreeterGrpcClient.create(client, SocketAddress.inetSocketAddress(0, "localhost"));
  ...
  public void jsonWireFormat(Vertx vertx) {
    ...
    GreeterClient greeter = GreeterGrpcClient.create(client, SocketAddress.inetSocketAddress(0, "localhost"), WireFormat.JSON);

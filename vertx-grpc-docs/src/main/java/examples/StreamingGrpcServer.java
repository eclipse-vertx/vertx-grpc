...
public class StreamingGrpcServer  {
  ...
  public StreamingGrpcServer bind_source(GrpcServer server) {
  ...
  public StreamingGrpcServer bind_sink(GrpcServer server) {
  ...
  public StreamingGrpcServer bind_pipe(GrpcServer server) {
  ...
  public StreamingGrpcServer bindAll(GrpcServer server) {
    bind_source(server);
    bind_sink(server);
    bind_pipe(server);
    return this;

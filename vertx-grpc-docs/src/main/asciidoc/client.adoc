...
The Vert.x gRPC client provides support for google protobuf method signatures.

You can add method signature option to service method like this:
[source,proto]
----
syntax = "proto3";
...
[source,java]
----
{@link examples.GrpcClientExamples#unaryStubSignature}
----

...
public class ServerTranscodingTest extends GrpcTestBase {
    ...
    public static final ServiceMethod<EchoRequest, EchoResponse> UNARY_CALL_WITH_PARAM = ServiceMethod.server(TEST_SERVICE_NAME, "UnaryCallWithParam", ECHO_RESPONSE_ENCODER, ECHO_REQUEST_DECODER);

...
public class ClientRequestTest extends ClientTest {
  ...
  public void testSSL(TestContext should) throws IOException {
    ...
    client = GrpcIoClient.client(vertx, new HttpClientOptions().setSsl(true)
      .setUseAlpn(true)
  ...
  public void testTimeoutOnClient(TestContext should) throws Exception {
    ...
    client = GrpcIoClient.client(vertx, new GrpcClientOptions().setScheduleDeadlineAutomatically(true));
    client.request(SocketAddress.inetSocketAddress(port, "localhost"), StreamingGrpc.getSinkMethod())
      .onComplete(should.asyncAssertSuccess(callRequest -> {
        callRequest
